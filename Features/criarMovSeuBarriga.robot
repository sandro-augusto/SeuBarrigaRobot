...
Cadastro de Movimentação com Sucesso
    ...
    Quando preencher os dados    Receita    18/09/2023    20/09/2023    ${FakerDescricao}    ${FakerInteressado}    ${FakerValor}    Pago
...
Cadastro de Movimentação com campo Data de Movimentação em branco
    Dado que o usuário clique em Criar Movimentação
    Quando preencher os dados    Receita    Null    20/10/2023    ${FakerDescricao}    ${FakerInteressado}    ${FakerValor}    Pago
...
Cadastro de Movimentação com campo Data de Pagamento em branco
    Dado que o usuário clique em Criar Movimentação
    Quando preencher os dados    Receita    10/08/2023    Null    ${FakerDescricao}    ${FakerInteressado}    ${FakerValor}    Pago
...
Cadastro de Movimentação com campo Descrição em branco
    Dado que o usuário clique em Criar Movimentação
    Quando preencher os dados    Receita    10/08/2023    20/10/2023    Null    ${FakerInteressado}    ${FakerValor}    Pago
...
Cadastro de Movimentação com campo Valor em branco
    Dado que o usuário clique em Criar Movimentação
    Quando preencher os dados    Receita    10/08/2023    20/10/2023    ${FakerDescricao}    ${FakerInteressado}    Null    Pago
